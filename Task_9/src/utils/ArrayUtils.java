...
public class ArrayUtils {
    ...
    */
    ...
    public static void readFileJList(JList jList, List<Integer> list) {
        DefaultListModel<Integer> list12 = new DefaultListModel<Integer>();
        list.forEach((value) -> list12.addElement(value));
        jList.setModel(list12);
    }
    public static void writeArrayToFile2(String fileName,String itemFormat )
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            out.println( itemFormat);
        }
    }
    ...
    public static void writeArrayToFile1(String fileName,List<Integer>  itemFormat )
            throws FileNotFoundException {
        try (PrintWriter out = new PrintWriter(fileName)) {
            out.println( itemFormat);
        }
